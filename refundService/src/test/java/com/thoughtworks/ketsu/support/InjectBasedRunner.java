...
public abstract class InjectBasedRunner extends BlockJUnit4ClassRunner {
    private static final String SERVER_URI = "http://127.0.0.1:8888";
    ...
    private List<AbstractModule> getAbstractModules() {
        ...
        String username = System.getenv().getOrDefault("DB_MYSQL_USER", "root");
        String password = System.getenv().getOrDefault("DB_MYSQL_PASS", "");
